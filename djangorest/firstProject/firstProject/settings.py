...
SECRET_KEY = "django-insecure-9y=^%4@us7qiheoe$tpo-aaj&r-k5ye$&af7f!9)4hf$g(+-n+"
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 2,
    # 'DEFAULT_FILTER_BACKENDS': ['django_filters.rest_framework.DjangoFilterBackend'], # for generic all app, but we are going specific.
